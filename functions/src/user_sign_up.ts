...
/// user_already_exist:
/// invalid_fiscal_code:
export const createUserSecondGen = onRequest(
  { cors: true },
...
export const verifyEmailSecondGen = onRequest(
  { cors: true },
  async (request, response) => {
    console.log(request.body);
...
export const recoverUserCardSecondGen = onRequest(
  { cors: true },
  async (request, response) => {
    console.log(request.body);
    ...
    if (providerId == null || userId == null || cf == null || gender == null) {
      const message =
        "Missing data: providerId: " +
        providerId +
        ", userId: " +
    ...
    if (userData == null) {
      ...
      throw new HttpsError("not-found", "User data null");
    }
    ...
    if (providerData == null) {
      ...
      throw new HttpsError("not-found", "Provider data null");
    }
...
export const requestGroupCardSecondGen = onRequest(
  { cors: true },
  async (request, response) => {
    console.log(request.body);
...
export const sendResetPasswordEmailSecondGen = onRequest(
  { cors: true },
  async (request, response) => {
    console.log(request.body);
...
export const changePasswordSecondGen = onRequest(
  { cors: true },
  async (request, response) => {
    console.log(request.body);
