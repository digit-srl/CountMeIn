...
class UserCardRecoveringState with _$UserCardRecoveringState {
  ...
  const factory UserCardRecoveringState.userNotExists() = UserCardRecoveringUserNotExists;
  const factory UserCardRecoveringState.invalidFiscalCode() = UserCardRecoveringInvalidFiscalCode;
