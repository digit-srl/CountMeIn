...
/// @nodoc
mixin _$UserCardRecoveringState {
  @optionalTypeArgs
...
class _$UserCardRecoveringInitialImpl implements UserCardRecoveringInitial {
  ...
  @override
  String toString() {
    return 'UserCardRecoveringState.initial()';
  }
...
class _$UserCardRecoveringLoadingImpl implements UserCardRecoveringLoading {
  ...
  @override
  String toString() {
    return 'UserCardRecoveringState.loading()';
  }
...
class _$UserCardRecoveringWaitingOtpCodeImpl
  ...
  @override
  String toString() {
    return 'UserCardRecoveringState.waitingOtpCode(ids: $ids)';
  }
...
class _$UserCardRecoveringProfileImpl implements UserCardRecoveringProfile {
  ...
  @override
  String toString() {
    return 'UserCardRecoveringState.profile(ids: $ids)';
  }
...
class _$UserCardRecoveringErrorImpl implements UserCardRecoveringError {
  ...
  @override
  String toString() {
    return 'UserCardRecoveringState.error(error: $error, st: $st)';
  }
